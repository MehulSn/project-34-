...
function setup() {
  ...
  box17 = new Box(900, 100, 80, 80);
  box18 = new Box(900, 100, 80, 80);
  box19 = new Box(900, 100, 80, 80);
  box20 = new Box(900, 100, 80, 80);
  box21 = new Box(900, 100, 80, 80);
  box22 = new Box(900, 100, 80, 80);
  box23 = new Box(900, 100, 80, 80);
  box24 = new Box(900, 100, 80, 80);
